...
Application frontend développée en JavaScript permettant de rechercher des profils GitHub, afficher leurs informations et gérer une liste de favoris.
...
- État d’erreur (user not found)
- État d’accueil (welcome)
- Vue favoris
